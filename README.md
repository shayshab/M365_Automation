...
# Run your script with detailed output
```
...
1. Check the knowledge documentation first
2. Review script comments and examples
3. Test in a development environment
4. Consult Microsoft documentation

## 📄 License

This project is provided as-is for educational and administrative purposes. Please review and comply with your organization's policies and Microsoft's terms of service.
...
**Compatibility**: Microsoft 365, Azure AD, Intune, Purview, Windows Server 2016+
# M365_Automation
